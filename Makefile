...
_DEPS = util.h ui.h config.h auth.h efield.h keys.h users.h sessions.h chvt.h launch_state.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJ = main.o util.o ui.o config.o auth.o efield.o users.o sessions.o chvt.o launch_state.o
